...
object PetAdoptApiConstants {
    ...
    /**
     * curl -d "grant_type=client_credentials&client_id={CLIENT-ID}&client_secret={CLIENT-SECRET}" https://api.petadopt.com/v2/oauth2/token
     */
    object Auth {
        //Paths
